...
public:
	...
	cv::Mat pcd2img(cv::Mat mat,pcl::PointCloud<pcl::PointXYZI> cloudin,cv::Mat &depth);
	pcl::PointCloud<pcl::PointXYZRGB> pclalignImg2LiDAR(cv::Mat mat,VLPPointCloud cloudin);
	pcl::PointCloud<pcl::PointXYZRGB> pclalignImg2LiDAR(cv::Mat mat, pcl::PointCloud<pcl::PointXYZI> cloudin,cv::Mat &depth);
